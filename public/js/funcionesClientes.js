...
const validateNombre = () => {
  ...
  const validateApellidos = () => {
    ...
    if (nombre === null || nombre === '' || nombre.length === 0) {
      ...
      texto = '<span style="color: #fff; background-color: #e6213f; padding: 3px;border-radius: 3px;">El apellido no puede estar vacio</span>';
      document.getElementById('textoa').innerHTML = texto;
      return false;
    } else if (nombre.length < 3) {
      
      texto = '<span style="color: #fff; background-color: #e6213f; padding: 3px;border-radius: 3px;">El apellido debe tener mas de dos caracteres</span>';
      document.getElementById('textoa').innerHTML = texto;
      return false;
    } else if (!expresion.test(nombre)) {
      
      texto = '<span style="color: #fff; background-color: #e6213f; padding: 3px;border-radius: 3px;">El apellido solo puede contener letras</span>';
      document.getElementById('textoa').innerHTML = texto;
      return false;
    } else {
...
function showActualizar() {
  Swal.fire({
    title: 'El cliente se ha modificado con éxito',
    icon: 'success',
